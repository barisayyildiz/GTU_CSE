...
\solution\newline
An element a $\in$ (A, $\subseteq$) is called maximal if there is
no other element b $\in$ A such that a $\subseteq$ b \newline
\{1,3,4\} and \{2,3,4\} are maximal elements \newline
\subproblem{b} Find the minimal elements.
\solution\newline
An element a $\in$ (A, $\subseteq$) is called minimal if there is no other element b $\in$ A such that b $\subseteq$ a \newline
\{1\}, \{2\} and \{4\} are minimal elements
\newline
\subproblem{c} Is there a greatest element?
\solution\newline
An element a $\in$ (A, $\subseteq$) is called the greatest (maximum) element if it is greater than every other
element of the poset: b $\subseteq$ a, ∀ b $\in$ A. 
\newline

That's why there is not a greatest element.
...
\{2,4\} and \{2,3,4\}
\newline
Because both \{2,4\} and \{2,3,4\} is a superset for $\{\{$2$\}$, $\{$4$\}\}$.
\newline
\subproblem{e} Find the least upper bound of $\{\{$2$\}$, $\{$4$\}\}$, if it exists.
\solution\newline
\{2,4\} \newline
Because it is a subset of \{2,3,4\}
\newline
\subproblem{f} Find all lower bounds of $\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$.
\solution\newline
\{4\}. Because \{4\} is the only subset for both \{1,3,4\} and \{2,3,4\}
\newline
\subproblem{h} Find the greatest lower bound of $\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$,
if it exists.
\solution\newline
\{4\} , because this is the only lower bound
\newline\newline
