...
\end{figure*}
\solution
\includegraphics[scale=0.4]{answer1}
...
There is not a Hamilton circuit\newline
\includegraphics[scale=0.5]{answer2_a.png}
\subproblem{b} \solution\\
There is not a Hamilton circuit, If we go from b to g, we would be stucked.\newline
Even if we started from the vertex g, we wouldn't come back to the vertex we started\newline
\includegraphics[scale=0.5]{answer2_b.png}
\subproblem{c} \solution\\
Yes there is a Hamilton circuit\newline
\includegraphics[scale=0.35]{answer2_c.png}
...
\newline
\solution
\includegraphics[scale=0.7]{answer3}
5 different timeslots are needed\newline\newline
In timeslot-1 : CSE 211, Math 101, Math 243\newline
In timeslot-2 : CSE 333, CSE 346\newline
In timeslot-3 : CSE 101\newline
In timeslot-4 : CSE 102\newline
In timelsot-5 : CSE 263\newline
\newpage
